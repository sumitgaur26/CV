...
export const experience: ExperienceRole[] = [
  {
    ...
    achievements: [
      ...
      "Lead the full performance appraisal cycle for 3 direct reports, including rating decisions and calibrated feedback delivery",
      "Facilitate open review discussions with the team to address appraisal questions and maintain transparency across the evaluation process",
    ],
  ...
  },
  {
    ...
    achievements: [
      ...
      "Owned the end-to-end performance appraisal cycle for a team of 5 direct reports: rating decisions, calibrated feedback, and team review discussions",
    ],
